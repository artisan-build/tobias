...
/*
 * Vendored from artisan-build/community-prompts (ArtisanBuild\CommunityPrompts\AsyncPrompt).
 * Carried locally only because community-prompts v0.3.0 pins illuminate/collections ^11,
 * which conflicts with prism-php/prism's laravel/framework ^12 here. Once community-prompts
 * allows illuminate ^12, replace this with a dependency on that package and delete this copy.
 */

namespace App\Support\Prompts;

use App\Support\Prompts\Output\AsyncConsoleOutput;
